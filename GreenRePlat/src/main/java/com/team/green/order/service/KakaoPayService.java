...
public class KakaoPayService {
    ...
    public ReadyResponseDTO payReady(String name, int totalPrice, String memId, int quantity ,HttpSession session) {
        ...
        parameters.put("approval_url", "http://192.168.0.136/order/completed"); 	// 결제 성공 시 URL
        parameters.put("cancel_url", "http://192.168.0.136/order/cancel");      // 결제 취소 시 URL
        parameters.put("fail_url", "http://192.168.0.136/order/fail");          // 결제 실패 시 URL
