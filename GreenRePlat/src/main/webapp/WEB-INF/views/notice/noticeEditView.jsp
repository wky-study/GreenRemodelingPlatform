	...
	<div class="container-fluid">
		<div class="card">
			...
			<div class="card-body">
				...
				<form id="noticeWriteForm" action="${pageContext.request.contextPath }/noticeEditDo" method="POST" enctype="multipart/form-data">
					...
					<div class="d-flex justify-content-end">
						<a class="btn btn-secondary me-2" href="${pageContext.request.contextPath }/noticeDetailView?no=${keyNotice.noticeNo}">취소</a>
