            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="header-row">
                        ...
                        <!-- 채팅 신청하기 폼 -->
                        <form action="${pageContext.request.contextPath}/requestChat" method="POST" class="chat-apply-form">
                            <select class="form-select" name="partMem" required>
                                ...
                                <c:forEach items="${memList}" var="member">
                                    <option style="color" value="${member.memId}">${member.memNick}</option>
                                </c:forEach>
                            </select>
                            ...
                            <tbody class="table-group-divider">
                                <c:forEach items="${roomList}" var="room">
                                    <tr>
                                        ...
                                        <td><a href="${pageContext.request.contextPath }/chatView?no=${room.roomNo}"
                                               class="link-primary text-dark fw-medium d-block">${room.roomName}</a></td>
